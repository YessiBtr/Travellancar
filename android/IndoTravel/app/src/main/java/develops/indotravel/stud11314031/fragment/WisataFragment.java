...
import develops.indotravel.stud11314031.adapter.WisataAdapter;
...
public class WisataFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        wisataList = realm.where(Wisata.class).findAll();

        adapter = new WisataAdapter(getActivity(), wisataList);
        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(getActivity(), 2);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.addItemDecoration(new WisataFragment.GridSpacingItemDecoration(2, dpToPx(10), true));
